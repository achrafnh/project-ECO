	...
	<div class="col-md-8">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?superadmin/student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="school_id" class="form-control select2" required>
                                ...
                                <?php
                                $parents = $this->db->get('school')->result_array();
...
<script type="text/javascript">
	...
	function get_class_sections(class_id) {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php?superadmin/get_class_section/' + class_id ,
