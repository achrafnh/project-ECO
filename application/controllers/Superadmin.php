...
class Superadmin extends CI_Controller
{
    ...
    function dashboard()
    {
        ...
        $page_data['page_name']  = 'dashboard_admin';
        $page_data['page_title'] = get_phrase('admin_dashboard');
        $this->load->view('backend/superindex', $page_data);
    }
    /****MANAGE SCHOOLS CLASS*****/
    function school_add()
    {
        if ($this->session->userdata('superadmin_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['page_name']  = 'school_add';
        $page_data['page_title'] = get_phrase('school_add');
        $this->load->view('backend/superindex', $page_data);
    }
    ...
    function delete_student($student_id = '', $class_id = '') {
        ...
        redirect(base_url() . 'index.php?superadmin/student_information/' . $class_id, 'refresh');
    }
    function school($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if($validation == 1){
                ...
                move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/school_image/' . $school_id . '.jpg');
            ...
            redirect(base_url() . 'index.php?superadmin/school_add/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['email']          = $this->input->post('email');
            ...
            if($validation == 1){
                ...
                move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/school_image/' . $param2 . '.jpg');
            ...
            redirect(base_url() . 'index.php?superadmin/school_information/' . $param3, 'refresh');
        }
    }
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if($validation == 1){
                ...
                if ($this->input->post('school_id') != '') {
                    $data2['school_id'] = $this->input->post('school_id');
                }
        ...
        if ($param1 == 'do_update') {
            ...
            redirect(base_url() . 'index.php?superadmin/student_information/' . $param3, 'refresh');
        }
    }
    ...
    function student_promotion($param1 = '' , $param2 = '')
    {
        ...
        if($param1 == 'promote') {
            ...
            redirect(base_url() . 'index.php?superadmin/student_promotion' , 'refresh');
        }
    ...
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/parent/', 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name']                   = $this->input->post('name');
            $data['email']                  = $this->input->post('email');
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/teacher/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['email']       = $this->input->post('email');
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?superadmin/subject/'.$data['class_id'], 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?superadmin/subject/'.$param3, 'refresh');
        }
        $running_year = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
    ...
    function upload_academic_syllabus()
    {
        ...
        redirect(base_url() . 'index.php?superadmin/academic_syllabus/' . $data['class_id'] , 'refresh');
    ...
    function delete_academic_syllabus($academic_syllabus_code) {
        ...
        $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
        redirect(base_url() . 'index.php?superadmin/academic_syllabus' , 'refresh');
    ...
    function sections($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/section/' . $data['class_id'] , 'refresh');
        }
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?superadmin/section' , 'refresh');
        }
    }
    ...
    function exam_marks_sms($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'send_sms') {
            ...
            redirect(base_url() . 'index.php?superadmin/exam_marks_sms' , 'refresh');
        }
    ...
    function marks2($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?superadmin/marks2/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?superadmin/marks2/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?superadmin/marks2/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function marks_selector()
    {
        ...
        if($data['class_id'] != '' && $data['exam_id'] != ''){
            ...
            redirect(base_url() . 'index.php?superadmin/marks_manage_view/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id'] , 'refresh');
        }
        else{
            $this->session->set_flashdata('error_message' , get_phrase('select_all_the_fields'));
            $page_data['page_name']  =   'marks_manage';
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        if ($class_id != '' && $exam_id != '') {
            ...
            redirect(base_url().'index.php?superadmin/marks_manage_view/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id , 'refresh');
        }
        else{
            $this->session->set_flashdata('error_message' , get_phrase('select_all_the_fields'));
            $page_data['page_name']  =   'marks_manage';
    ...
    function tabulation_sheet($class_id = '' , $exam_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0) {
                redirect(base_url() . 'index.php?superadmin/tabulation_sheet/' . $page_data['class_id'] . '/' . $page_data['exam_id'] , 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose class and exam');
                redirect(base_url() . 'index.php?superadmin/tabulation_sheet/', 'refresh');
            }
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/class_routine_add/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class_id']       = $this->input->post('class_id');
            if($this->input->post('section_id') != '') {
            ...
            redirect(base_url() . 'index.php?superadmin/class_routine_view/' . $data['class_id'], 'refresh');
        }
        else if ($param1 == 'edit') {
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?superadmin/class_routine_view/' . $class_id, 'refresh');
        }
    ...
    function attendance_selector()
    {
        ...
        redirect(base_url().'index.php?superadmin/manage_attendance_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['timestamp'],'refresh');
    }
    ...
    function attendance_update($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        redirect(base_url().'index.php?superadmin/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp , 'refresh');
    }
    ...
    function manage_attendance2($date='',$month='',$year='',$class_id='' , $section_id = '' , $session = '')
    {
        ...
        if($_POST)
        {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?superadmin/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$session , 'refresh');
        }
        $page_data['date']       =	$date;
    ...
    function attendance_selector2()
    {
        ...
        redirect(base_url() . 'index.php?superadmin/manage_attendance/'.$this->input->post('date').'/'.
    ...
    {   if($this->input->post('class_id') == '' || $this->input->post('sessional_year') == '') {
        ...
        redirect(base_url() . 'index.php?superadmin/attendance_report_view/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['month'] . '/' . $data['sessional_year'], 'refresh');
    }
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?superadmin/student_payment', 'refresh');
        }
    ...
    function expense_category($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?superadmin/expense_category');
        }
        if ($param1 == 'edit') {
            $data['name']   =   $this->input->post('name');
    ...
    function frontend_events($param1 = '', $param2 = '') {
        if ($param1 == 'add_event') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/events', 'refresh');
        }
    ...
    function frontend_gallery($param1 = '', $param2 = '', $param3 = '') {
        if ($param1 == 'add_gallery') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/gallery', 'refresh');
        }
        ...
        if ($param1 == 'upload_images') {
            ...
            redirect(base_url().'index.php?superadmin/frontend_pages/gallery_image/'.$param2, 'refresh');
        }
        if ($param1 == 'delete_image') {
            ...
            redirect(base_url().'index.php?superadmin/frontend_pages/gallery_image/'.$param3, 'refresh');
        }
        // if ($param1 == 'delete') {
    ...
    function frontend_news($param1 = '', $param2 = '') {
        if ($param1 == 'add_news') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/news', 'refresh');
        }
        if ($param1 == 'edit_news') {
    ...
    function frontend_settings($task) {
        if ($task == 'update_terms_conditions') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/terms_conditions', 'refresh');
        }
        if ($task == 'update_about_us') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/about_us', 'refresh');
        }
        if ($task == 'update_privacy_policy') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/privacy_policy', 'refresh');
        }
        if ($task == 'update_general_settings') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/general', 'refresh');
        }
        if ($task == 'update_slider_images') {
            ...
            redirect(base_url() . 'index.php?superadmin/frontend_pages/homepage_slider', 'refresh');
        }
    }
    ...
    function update( $task = '', $purchase_code = '' ) {
        ...
        redirect(base_url() . 'index.php?superadmin/system_settings');
    }
    ...
    function question_paper($param1 = "", $param2 = "")
    {
        ...
        $this->load->view('backend/superindex', $data);
    }
    ...
    function librarian($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/librarian/', 'refresh');
        }
    ...
    function accountant($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/accountant', 'refresh');
        }
                ...
                foreach ($csv as $row) {
                    ...
                    if ($validation == 1) {
                        ...
                        if ($array_size == 2) {
                            ...
                            redirect(base_url() . 'index.php?superadmin/student_bulk_add', 'refresh');
                        }
                        elseif($array_size > 2){
    ...
    function study_material($task = "", $document_id = "")
    {
        ...
        if ($task == "create")
        {
            ...
            redirect(base_url() . 'index.php?superadmin/study_material' , 'refresh');
        }
        ...
        if ($task == "delete")
        {
            ...
            redirect(base_url() . 'index.php?superadmin/study_material');
        }
